...
int reader_main(char *argv, struct reader_info_type *rdr_info)
{
  TMR_Reader r, *rp;
  TMR_Status ret;
  TMR_Region region;
...

  {
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_ver, str.value);
    }
    else
    {
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_ser, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_mod, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_sw_ver, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    {
      //printf("/reader/uri:  %s\n",str.value);
      strcpy(rdr_info->rdr_uri, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      rdr_info->rdr_prd_grp_id = productGroupID;
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_prd_grp, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
    ...
    if (TMR_SUCCESS == ret)
    {
      ...
      strcpy(rdr_info->rdr_dsc, str.value);
    }
    else
    {
      if (TMR_ERROR_NOT_FOUND == ret)
